...
$data_datapustaka = $datapustaka->tampil_datapustaka_periode_sma($id_semester);
...
<div class="row">
	<div class="col-md-6">
		<h3>Data Kegiatan Perpustakaan SMA </h3>
		<h3>Sekolah Sukma Bangsa <?php echo  ($db_lokasi)?></h3>
	</div>
	<div class="col-md-6">
		<div class="tambah-user hidden-print">
		<a href="index.php?halaman=cek_tampil_pustaka_sma" class="btn btn-primary">Pilih Semester</a>
...
<html>
<head>
	<title>Data Kegiatan Perpustakaan SMA</title>
