...
$semua_kegiatan = $kegiatan->tampil_kegiatan_periode_sd($id_semester);
...
<div class="row">
	<div class="col-md-6">
		<h3>Data Kegiatan Peningkatan Kapasitas Guru SD</h3>
		<h3>Sekolah Sukma Bangsa <?php echo ($db_lokasi)?></h3>
		
	</div>
	<div class="col-md-6">
		<div class="tambah-user hidden-print">
		<a href="index.php?halaman=cek_tampil_periode_kegiatan_sd" class="btn btn-primary">Pilih Semester</a>
...
<html>
<head>
	<title>Data kegiatan Peningkatan Kapasitas Guru SD</title>
