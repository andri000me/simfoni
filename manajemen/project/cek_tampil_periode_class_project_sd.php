...
<div class="row">
	<div class="col-md-6">
<h3>Pilih Data Semester Class Project SD</h3>
<hr>
		...
		<?php 
			if (isset($_POST['proses']))
			{
				...
				if ($id_semester == "kosong") 
				{
					...
					echo "<script>location='index.php?halaman=cek_tampil_periode_class_project_sd' </script>";

				} else {
					echo "<script>location='index.php?halaman=tampil_periode_class_project_sd&id_semester=$id_semester' </script>";
				}
