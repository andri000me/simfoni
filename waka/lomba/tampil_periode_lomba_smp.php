...
$data_lomba = $lomba->tampil_periode_lomba_smp($id_tp);
...
<div class="row">
	<div class="col-md-6">
		<h3>Data Hasil Lomba Siswa SMP </h3>
		<h3>Sekolah Sukma Bangsa <?php echo  ($db_lokasi)?></h3>
	</div>
	<div class="col-md-6">
		<div class="tambah-user hidden-print">
		<a href="index.php?halaman=cek_tampil_periode_lomba_smp" class="btn btn-primary">Pilih Tahun Pelajaran</a>
