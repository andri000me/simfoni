...
$data_lomba = $lomba->tampil_periode_lombasma($id_tp);
...
<div class="row">
	<div class="col-md-6">
		<h3>Data Hasil Lomba Siswa SMA </h3>
		<h3>Sekolah Sukma Bangsa <?php echo  ($db_lokasi)?></h3>
	</div>
	<div class="col-md-6">
		<div class="tambah-user hidden-print">
		<a href="index.php?halaman=cek_tampil_periode_lomba_sma" class="btn btn-primary">Pilih Tahun Pelajaran</a>
