...
$semua_visit = $visit->tampil_visit_periode_sma($id_semester);
...
<div class="row">
	...
	<div class="col-md-6">
		...
		<a href="index.php?halaman=cek_tampil_periode_visit_sma" class="btn btn-primary">Pilih Semester</a>
...
<div class="row">
	<div class="col-md-12">
		...
		<tr>
			...
			<?php echo $value['nama_mapel1'] ;?> <br> <?php echo $value['nama_mapel2'] ;?> <br> <?php echo $value['nama_mapel3'] ;?> <br> <?php echo $value['nama_mapel4'] ;?> </td>
