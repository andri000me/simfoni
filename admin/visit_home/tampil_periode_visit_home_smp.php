...
$semua_visit_home = $visit_home->tampil_visit_home_periode_smp($id_semester);
...
<div class="row">
	<div class="col-md-6">
		<h3>Data Home Visit SMP </h3>
		<h3>Sekolah Sukma Bangsa <?php echo  ($db_lokasi)?></h3>
	</div>
	<div class="col-md-6">
		<div class="tambah-user hidden-print">
		<a href="index.php?halaman=cek_tampil_periode_visit_home_smp" class="btn btn-primary">Pilih Semester</a>
...
<html>
<head>
	<title>Data Home Visit SMP</title>
