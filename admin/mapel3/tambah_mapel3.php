<h1>Tambah Data Mata Pelajaran Kolaborasi 3</h1>
<hr>
	...
	<div class="col-md-6">
		<form method="POST">			
			...
			<div class="form-group">
				...
				<input type="text" name="nama_mapel3" class="form-control" required="">
			</div>
		...
		<?php 
			...
			{
				$mapel3->simpan_mapel3($_POST['id_jenjang'], $_POST['nama_mapel3']);
