<div class="row">
	<div class="col-md-6">
		<h1>Data Mata Pelajaran Kolaborasi 1</h1>
	</div>
	<div class="col-md-6">
		<div class="tambah-user">
		<a href="index.php?halaman=tambah_mapel1" class="btn btn-primary">Tambah</a>
...
<table class="table table-bordered" id="data-table" >
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="index.php?halaman=edit_mapel1&id_mapel1=<?php echo $value['id_mapel1'] ?>" class="btn btn-warning">Edit</a>
				<a href="index.php?halaman=hapus_mapel1&id_mapel1=<?php echo $value['id_mapel1']; ?>" class="btn btn-danger" onclick="return confirm('hapus data <?php echo $value["nama_mapel1"]; ?> ?')">Hapus</a>
			</td>
		</tr>
		<?php endforeach ?>
	</tbody>
