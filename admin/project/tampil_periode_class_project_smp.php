...
$semua_project = $project->tampil_class_project_periode_smp($id_semester);
...
<div class="row">
	...
	<div class="col-md-6">
		...
		<a href="index.php?halaman=cek_tampil_periode_class_project_smp" class="btn btn-primary">Pilih Semester</a>
