<div class="row">
	...
	<div class="col-md-6">
		...
		<a href="index.php?halaman=tambah_class_project" class="btn btn-primary">Tambah Data Class Project</a>
...
$semua_project = $project->tampil_project_admin();
...
<div class="row">
 ...
 -->
			<td class="hidden-print"> 
				<a href="index.php?halaman=edit_class_project&id_project=<?php echo $value['id_project']; ?>" class="" >Ubah Data</a>  <br> <br>
				<a href="index.php?halaman=hapus_class_project&id_project=<?php echo $value['id_project']; ?>" class="" onclick="return confirm('hapus data tema class project <?php echo $value["tema_project"]; ?>') " >Hapus Data</a>  
