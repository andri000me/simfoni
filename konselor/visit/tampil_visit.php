<div class="row">
	...
	<div class="col-md-6">
		...
		<a href="index.php?halaman=tambah_visit" class="btn btn-primary">Tambah Data Home Visit</a>
	...
	<div class="col-md-12">
		...
		<tr>
			...
			<td class="hidden-print"> 
				...
				<a href="index.php?halaman=hapus_visit&id_visit=<?php echo $value['id_visit']; ?>" class="" onclick="return confirm('hapus data school visit <?php echo $value["tema_visit"]; ?>') " >Hapus Data</a> 
