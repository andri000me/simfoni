...
$data_periode = $visit->ambil_periode_visit($id_semester);
$data_visit = $visit->tampil_class_visit_periode($id_semester);
...
<div class="row">
	...
	<div class="col-md-6">
		...
		<a href="index.php?halaman=cek_tampil_periode_visit" class="btn btn-primary">Pilih Semester</a>
...
<div class="row">
	<div class="col-md-12">
		...
		<table class="table table-bordered" id="data-table">
			...
			<tbody>
				<?php foreach ($data_visit as $key => $value): ?>
 ...
 -->
				...
				<a href="index.php?halaman=edit_visit&id_visit=<?php echo $value['id_visit']; ?>" class="" >Ubah Data</a> <br>  
