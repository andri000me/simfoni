	...
	<div class="col-md-12">
		...
		<table class="table table-bordered">
			...
			<thead>
				<tr>
					...
					<th>Semester</th>
					<th>Kelas</th>
					<th>Koordinator School Visit</th>
		...
		<tr>
			...
			<td><?php echo $value['laporan'] ?> <br>
				<a href="index.php?halaman=upload_laporan_visit&id_visit=<?php echo $value['id_visit']; ?>" class="" >Upload</a> <br>	

				<a href="../../laporan/school_visit/<?php echo $value['laporan'] ?>" class="" >Download</a>	
			</td>
			...
			<td class="hidden-print"> <br>
				<a href="index.php?halaman=edit_visit&id_visit=<?php echo $value['id_visit']; ?>" class="" >Ubah</a> <br> 
				<a href="index.php?halaman=hapus_visit&id_visit=<?php echo $value['id_visit']; ?>" class="" onclick="return confirm('hapus data school visit <?php echo $value["tema_visit"]; ?>') " >Hapus</a> 
