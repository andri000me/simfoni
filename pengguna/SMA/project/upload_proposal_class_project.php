...
<html>
<head>
	<title>Upload Proposal Class Project SMA</title>
</head>
<body>
	<h1>Upload Proposal Class Project SMA</h1>
	<hr>
	...
	<div class="col-md-6">
		...
		<?php 
			if (isset($_POST['upload']))
			{
				...
				$database->query("UPDATE project SET proposal='$nama' WHERE id_project='$id_project'");
				}
				else
				{
					$database = new mysqli("localhost", "root", "kebersamaan", "simfoni");
